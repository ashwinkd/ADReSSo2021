...
for (idx, (speaker,
    ...
    if speaker not in data_final:
        ...
        tags, disfluency, underscore, uh, rep, ret = data_final[speaker][1:7]
        tags += " " + transcript_without_tags
        disfluency += " " + transcript_without_disfluency
        underscore += " " + transcript_without_underscore
        uh += " " + transcript_without_uh
        rep += " " + transcript_without_repetition
        ret += " " + transcript_without_retracing
        data_final[speaker] = (speaker,
                               tags,
                               disfluency,
                               underscore,
